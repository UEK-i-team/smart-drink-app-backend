import { DrinksResponseDto } from 'src/dto';
import { FlavorProfiles, Strengths } from 'src/enum';

export const MOCK_DRINKS_RESPONSE: DrinksResponseDto = {
  ...
  drinks: [
    {
      ...
      instructions: [
        'Muddle mint leaves with lime juice and syrup',
        'Add rum and ice',
        'Top with soda water',
        'Garnish with mint sprig',
      ],
      image_description:
        'A tall glass filled with ice, fresh mint leaves, and bubbling clear liquid with a lime wedge on the rim, bright natural lighting',
    ...
    },
    {
      ...
      image_description:
        'A lowball glass with amber liquid over a large ice cube, orange peel twist, warm bar lighting',
      image_url: 'https://www.thecocktaildb.com/images/media/drink/metwgh1606770327.jpg',
    },
    {
      name: 'Aperol Spritz',
      ...
      image_description:
        'A wine glass with bright orange cocktail, ice cubes, and an orange slice, summer terrace background',
